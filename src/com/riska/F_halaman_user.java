 ...
 * @author User
 */
public class F_halaman_user extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    public F_halaman_user() {
        ...
        user_id.setText(toString().valueOf(F_Login.getid()));
        judul_daftar();
        tampil();
        tampil_daftar();
...
//        com2.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Membaca adalah tiket diskon kemana - mana.");
        ...
        daftar.setBackground(new java.awt.Color(204, 204, 204));
        daftar.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        pinjam.setBackground(new java.awt.Color(156, 170, 185));
        pinjam.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        pinjam.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pinjamMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                pinjamMouseExited(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addComponent(pinjam, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
        );
        jPanel5Layout.setVerticalGroup(
            jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pinjam, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );
        ...
        kembali.setBackground(new java.awt.Color(156, 170, 185));
        kembali.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addComponent(kembali, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(kembali, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );
    ...
    private void pinjamMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pinjamMouseEntered
        // TODO add your handling code here:
        setColor(jPanel5);
    }//GEN-LAST:event_pinjamMouseEntered
    ...
    private void pinjamMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pinjamMouseExited
        // TODO add your handling code here:
        jPanel5.setBackground(new java.awt.Color(108,122,137));
    }//GEN-LAST:event_pinjamMouseExited
    ...
    private void pinjamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pinjamActionPerformed
        // TODO add your handling code here:
        pinjam.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        new F_Peminjaman().show();
        this.dispose();
    }//GEN-LAST:event_pinjamActionPerformed

    private void kembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kembaliActionPerformed
        // TODO add your handling code here:
        kembali.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        F_pengaturan_user pu = new F_pengaturan_user();
        pu.show();
        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        F_detail_user du = new F_detail_user();
        du.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_halaman_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_halaman_user().setVisible(true);
            }
        });
    }
