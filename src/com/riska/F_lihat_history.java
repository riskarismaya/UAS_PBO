...
public class F_lihat_history extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    private void initComponents() {
        ...
        cari_transaksi.setBackground(new java.awt.Color(0, 102, 102));
    ...
    private void logout1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logout1ActionPerformed
        // TODO add your handling code here:
        F_halaman_operator ho = new F_halaman_operator();
        ho.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_lihat_history.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_lihat_history().setVisible(true);
            }
        });
    }
