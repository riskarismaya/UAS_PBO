 ...
 * @author User
 */
public class F_daftar_user extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    private void initComponents() {
        ...
        telp_user.setBackground(new java.awt.Color(0, 102, 102));
        ...
        alamat_user.setBackground(new java.awt.Color(0, 102, 102));
        ...
        nama_user.setBackground(new java.awt.Color(0, 102, 102));
        ...
        pass_konfir.setBackground(new java.awt.Color(0, 102, 102));
    ...
    private void daftar_userActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_daftar_userActionPerformed
        ...
        if(kosong()){
            ...
            F_Kebijakan kb = new F_Kebijakan();
            kb.show();
            int jawab;
            if((jawab = JOptionPane.showConfirmDialog(null,"Dengan menekan tombol 'Yes' maka anda menerima segala kebijakan perpustakaan ini", "Konfirmasi", JOptionPane.OK_CANCEL_OPTION)) == 0){
                try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_daftar_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_daftar_user().setVisible(true);
            }
        });
    }
