 ...
 * @author User
 */
public class F_lihat_buku extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_lihat_buku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_lihat_buku().setVisible(true);
            }
        });
    }
