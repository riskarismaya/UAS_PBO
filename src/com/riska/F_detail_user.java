 ...
 * @author User
 */
public class F_detail_user extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    String sql;
    ...
    private void initComponents() {
        ...
        kd_pinjam.setBackground(new java.awt.Color(0, 102, 102));
        ...
        tgl_pinjam.setBackground(new java.awt.Color(0, 102, 102));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_detail_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_detail_user().setVisible(true);
            }
        });
    }
