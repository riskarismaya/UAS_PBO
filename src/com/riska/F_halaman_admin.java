 ...
 * @author User
 */
public class F_halaman_admin extends javax.swing.JFrame {
    public Statement st;
    public ResultSet rs;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_halaman_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_halaman_admin().setVisible(true);
            }
        });
    }
