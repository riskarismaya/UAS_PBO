 ...
 * @author User
 */
public class F_pengaturan_user extends javax.swing.JFrame {
    ...
    public F_pengaturan_user() {
        ...
        user_id.setEditable(false);
        user_id.setText(toString().valueOf(F_halaman_user.getid()));
        tampil();
    }
    public void reset(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_pengaturan_user.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_pengaturan_user().setVisible(true);
            }
        });
    }
